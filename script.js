...
//Créer div
//Crée un élément de type div
let myDiv = document.createElement("div");
 //creer une div
myDiv.setAttribute("id", "myDivId"); 
// ajoute un id à la div du nom de myDivID
...
maDiv.setAttribute('class','connard');
console.log(maDiv);
...
//on ajoute un attribut de type class
paragraphe.class = 'putainDeP';
//on crée un noeud de type text
let text = document.createTextNode('Inséré !');
//On insère le texte dans le paragraphe / append:ajouter
paragraphe.appendChild(text);
//On insère le texte dans notre paragraphe
//dernier enfant de body 
//auquel on accède directement avec "document.body"
document.body.appendChild(paragraphe);
//afficher dans la console de la page web
console.log(paragraphe);

//ligne donné par max
//elementHTML.setAttribute("class", "nom de ta class")
*/
// 1er div container
let myDiv = document.createElement('div');
